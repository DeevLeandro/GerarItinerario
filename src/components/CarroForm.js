...
const CarroForm = ({
  ...
  // hospedagens vinculadas (igual ao trecho aéreo)
    ...
    <div className="trecho-bloco">
      <div className="trecho-card carro-card">
        ...
        <div className="field-group">
          <div className="field-wrap">
            ...
            <input
              type="number" min="0"
              placeholder="0"
              value={carro.distanciaKm}
              onChange={e => u('distanciaKm', e.target.value)}
            />
          </div>
          <div className="field-wrap">
            <label>Empresa / Serviço</label>
            <input
              placeholder="Ex: Localiza, Uber, Transfer VIP..."
              value={carro.empresa}
        ...
        {(carro.tipo === 'ALUGUEL') && (
          <div className="field-group">
            <div className="field-wrap">
              <label>Modelo / Categoria do Carro</label>
              <input
        ...
        {(carro.tipo === 'UBER' || carro.tipo === 'OUTRO') && (
          <div className="field-group">
            <div className="field-wrap">
      ...
      {/* Hospedagens vinculadas ao trecho de carro */}
